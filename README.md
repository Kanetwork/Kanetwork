...
🚔 Career Transition: Policing → Cyber Security  
...
### Networking
TCP/IP • VLANs • Routing • Firewalls • Packet Analysis

### Security
Threat Detection • Log Analysis • Incident Investigation • Risk Assessment

### Cloud
AWS IAM • VPC Design • Cloud Monitoring • Shared Responsibility Model
